package com.kotlin.geekbrains_dlls.mvp.model.entity.room.DAO
...
interface UserDao {
    ...
    @Query("SELECT * FROM RoomGithubUser WHERE reposUrl = :url LIMIT 1")
    fun findByUrl(url: String): RoomGithubUser?
}